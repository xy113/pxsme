...
<div class="page-wrap">
	<div class="bodyLeft">
		<div class="yourpos">当前位置：<a href="./">首页</a> >> <a href="arclist-<?php echo $this->_tpl_vars['article']['cid']; ?>
...
　浏览：<?php echo $this->_tpl_vars['article']['views']; ?>
</div>
		<div class="article-body"><?php echo $this->_tpl_vars['article']['content']; ?>
</div>
		<div class="titlediv">相关链接</div>
		<ul class="list">
...
"><?php echo $this->_tpl_vars['arc']['title']; ?>
		...
		<div class="titlediv">相关评论</div>
		<span id="article_comment">正在加载数据...</span>
